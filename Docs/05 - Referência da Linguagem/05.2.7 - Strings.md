...
> Nota: Como esta sintaxe permite expressões arbitrárias, é possível usar variáveis variáveis dentro da sintaxe avançada.
...
> Nota: Anteriormente ao PHP 8.0.0, strings também poderiam ser usados utilizandos chaves, por exemplo $str{42}. Essa sintaxe por chaves foi descontinuada desde o PHP 7.4.0 e não é mais suportadada a partir do PHP 8.0.0.
